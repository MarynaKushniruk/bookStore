...
public class ShoppingCartRepositoryTests {
    ...
    void findByUserId_ShoppingCartExists_Ok() {
        Optional<ShoppingCart> shoppingCart = shoppingCartRepository.findShoppingCartByUser_Id(3L);
        Assertions.assertNotNull(shoppingCart);
        Assertions.assertEquals(3L, shoppingCart.get().getUser().getId());
    }
    ...
    void findByUserId_ShoppingCarNotExists_ReturnIsEmpty() {
        long id = 5;
        Optional<ShoppingCart> shoppingCart = shoppingCartRepository.findShoppingCartByUser_Id(id);
