...
public class ShoppingCartControllerIntegrationTest {
    ...
    void updateQuantityOfItems_ValidQuantity_Ok() throws Exception {
        CartItemUpdateQuantityDto updateRequest = getCartItemUpdateRequestDto();
        CartItemResponseDto expected = createCartItemDto().setQuantity(
    ...
    private CartItemResponseDto createCartItemDto() {
        return new CartItemResponseDto().setId(ID)
                .setBookId(ID).setBookTitle("Odyssey").setQuantity(2);
    }

    private CartItemUpdateQuantityDto getCartItemUpdateRequestDto() {
        return new CartItemUpdateQuantityDto()
                .setQuantity(2);
    }
}
